      ...
      <header className="flex flex-wrap items-center p-4 md:py-8">
        ...
        <div className="w-8/12 md:w-7/12 ml-4">
          ...
          <ul className="hidden md:flex space-x-8 mb-4">
            <li>
              <span className=" text-black font-bold ">136</span>
              posts
            </li>
            <li>
              <span className="text-black font-bold ">40.5k</span>
              followers
            </li>
            <li>
              <span className="text-black font-bold ">302</span>
              following
            </li>
          </ul>
          {/* user meta form medium screens */}
          <div className="hidden md:block">
            <h1 className="text-black font-bold ">Mr Travlerrr...</h1>
        ...
        >
          ...
          <li className="md:border-t md:border-gray-700 md:-mt-px md:text-gray-700">
            <a className="inline-block p-3" href="#">
              ...
              <span className="hidden md:inline text-black font-bold">post</span>
            </a>
          </li>
          <li>
            <a className="inline-block p-3" href="#">
              <i className="far fa-square text-xl md:text-xs" />
              <span className="hidden md:inline text-black font-bold">followers</span>
            </a>
          </li>
          <li>
            <a className="inline-block p-3" href="#">
             
              <span className="hidden md:inline text-black font-bold">following</span>
            </a>
          </li>
        </ul>
        {/* flexbox grid */}
